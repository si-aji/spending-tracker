@section('parentTitle', 'Wallet: Re Order')
@section('breadcrumb')
    ...
    <div class="card border">
        <div class="card-header border-bottom pb-0">
            <div class="d-sm-flex align-items-center">
                <div>
                    <h6 class="font-weight-semibold text-lg mb-0">Wallet: Re-order</h6>
                    <p class="text-sm">Change how your wallet order</p>
                </div>
        ...
        <div class="card-body">
            <div class="sa-sortable" wire:ignore>
                <ol id="wallet-list">
                    @foreach ($walletList_data as $item)
...
@section('js_inline')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            window.dispatchEvent(new Event('walletListInit-re_order'));
        });
        window.addEventListener('walletListInit-re_order', (e) => {
            console.log('Wallet List Init');
            initNestable();
        });
    </script>
@endsection